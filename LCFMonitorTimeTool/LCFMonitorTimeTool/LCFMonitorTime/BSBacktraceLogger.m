...
thread_t bs_machThreadFromNSThread(NSThread *nsthread) {
    ...
    /*
     task_threads: 可以获取到所有的线程，注意这里的线程是最底层的 mach 线程
     mach_task_self: 获得任务的端口，带有发送权限的名称,也可以理解为获取当前的任务
     */
    ...
    for (int i = 0; i < count; ++i) {
        ...
        if (pt) {
            ...
            /*
             ...
             若str1>str2，则返回正数
             */
            /// 如果获取的线程名与originName的线程名相等就返回当前线程
...
bool bs_fillThreadStateIntoMachineContext(thread_t thread, _STRUCT_MCONTEXT64 *machineContext) {
